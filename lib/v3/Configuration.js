...
const CHROMICIOUS_VERSION = '2.5.1';

// URLs
var SAVE_URL = 'http://delicious.com/save?v=4&noui=yes&jump=close&url=';
...
// Windows params
const SAVE_WINDOW_HEIGHT 	= 440;
const SAVE_WINDOW_WIDTH 	= 700;
    ...
    chrome.windows.getCurrent(function selectCurrentTab(chromewindow) {
		...
		chrome.tabs.sendRequest(chrometab.id, {id: 'getPageDetails'}, function(response) {
			...
			var saveWindow = window.open(
				url, "saveBookmarkWindow_" + url,
                    "toolbar=no, height=" + SAVE_WINDOW_HEIGHT + "," +
